      ...
      <div style={{ display: "grid", gridTemplateColumns: selected ? "1fr 320px" : "1fr", gap: 16, alignItems: "start" }}>
        ...
        <div className="table-wrap">
          <table>
            ...
            <tbody>
              {loading && (
                <tr><td colSpan={7} style={{ textAlign: "center", padding: 32, color: "var(--color-text-muted)" }}>Searching…</td></tr>
              )}
                  ...
                  <td>
                    {m.mobile ? (
                      <div className="flex items-center gap-2">
                        <span style={{ fontFamily: "monospace", fontSize: 12 }}>{m.mobile}</span>
                        <button
        ...
        {selected && (
          <div className="card" style={{ position: "sticky", top: 20 }}>
            ...
            <div className="card-body" style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              {selected.mobile && (
                <div>
                  <div className="label mb-1">Mobile</div>
                  <div className="flex items-center gap-2">
                    <span style={{ fontFamily: "monospace", fontSize: 13 }}>{selected.mobile}</span>
                    <button
              ...
              {selected.membership_type_name && (
                <div>
                  <div className="label mb-1">Membership</div>
              ...
              {selected.last_donation && (
                <div>
                  <div className="label mb-1">Last Donation</div>
